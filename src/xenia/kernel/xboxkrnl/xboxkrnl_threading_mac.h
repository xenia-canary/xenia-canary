...
#ifndef XENIA_KERNEL_XBOXKRNL_XBOXKRNL_THREADING_MAC_H_
#define XENIA_KERNEL_XBOXKRNL_XBOXKRNL_THREADING_MAC_H_
...
#endif  // XENIA_KERNEL_XBOXKRNL_XBOXKRNL_THREADING_MAC_H_
