...
#ifndef XENIA_KERNEL_USER_MODULE_MAC_H_
#define XENIA_KERNEL_USER_MODULE_MAC_H_
...
class UserModule : public XModule {
 ...
 private:
  ...
  // Keep buffered source bytes alive across LoadFromMemory -> LoadContinue
  // transitions for buffered CD-ROM loads.
  std::vector<uint8_t> staged_buffered_source_;
};

}  // namespace kernel
}  // namespace xe

#endif  // XENIA_KERNEL_USER_MODULE_MAC_H_
