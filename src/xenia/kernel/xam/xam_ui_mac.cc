...
dword_result_t XamShowFriendsUI_entry(dword_t user_index, dword_t flags) {
  XELOGI("!! XamShowFriendsUI stub called - returning SUCCESS");
  return 0;  // Success (UI "shown" and closed)
}
...
dword_result_t XamShowGamerCardUIForXUID_entry(dword_t user_index,
                                               qword_t xuid,
                                               dword_t flags) {
  XELOGI("!! XamShowGamerCardUIForXUID stub called - returning SUCCESS");
  return 0;  // Success
}
DECLARE_XAM_EXPORT1(XamShowGamerCardUIForXUID, kUI, kStub);

dword_result_t XamShowPlayerReviewUI_entry(dword_t user_index, qword_t xuid) {
  XELOGI("!! XamShowPlayerReviewUI stub called - returning SUCCESS");
  return 0;  // Success
}
DECLARE_XAM_EXPORT1(XamShowPlayerReviewUI, kUI, kStub);

dword_result_t XamShowFriendRequestUI_entry(dword_t user_index, qword_t xuid) {
  XELOGI("!! XamShowFriendRequestUI stub called - returning SUCCESS");
  return 0;  // Success  
}
DECLARE_XAM_EXPORT1(XamShowFriendRequestUI, kUI, kStub);

dword_result_t XamShowMessageComposeUI_entry(dword_t user_index,
                                             qword_t recipient_xuid,
                                             lpvoid_t text_ptr, dword_t flags,
                                             dword_t overlapped) {
  XELOGI(
      "!! XamShowMessageComposeUI stub called - user_index={} "
      "recipient_xuid={:016X}",
      static_cast<uint32_t>(user_index),
      static_cast<uint64_t>(recipient_xuid));
  return X_ERROR_SUCCESS;
}
DECLARE_XAM_EXPORT1(XamShowMessageComposeUI, kUI, kStub);

dword_result_t XamShowCustomMessageComposeUI_entry(
    dword_t user_index, lpvoid_t recipients_ptr, dword_t recipient_count,
    lpvoid_t text_ptr, dword_t flags, dword_t overlapped) {
  XELOGI(
      "!! XamShowCustomMessageComposeUI stub called - user_index={} "
      "recipient_count={}",
      static_cast<uint32_t>(user_index),
      static_cast<uint32_t>(recipient_count));
  return X_ERROR_SUCCESS;
}
DECLARE_XAM_EXPORT1(XamShowCustomMessageComposeUI, kUI, kStub);
