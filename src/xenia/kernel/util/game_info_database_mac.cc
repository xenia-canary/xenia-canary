...
std::optional<GameInfoDatabase::Context> GameInfoDatabase::GetContext(
  ...
  if (context.description.empty()) {
    switch (context.id) {
      case 0x00000000: context.description = "Game Mode"; break;
      case 0x0000800A: context.description = "Game Type"; break;
      default:
        context.description = fmt::format("Unknown Context {:08X}", context.id);
        break;
    }
  }
  return context;
...
std::optional<GameInfoDatabase::Property> GameInfoDatabase::GetProperty(
  ...
  if (property.description.empty()) {
    switch (property.id) {
      case 0x10008001: property.description = "Rank"; break;
      case 0x10008101: property.description = "Gamer Zone"; break;
      case 0x10008102: property.description = "Gamer Country"; break;
      case 0x10008103: property.description = "Language"; break;
      case 0x10008201: property.description = "Platform Type"; break;
      case 0x10008202: property.description = "Platform Lock"; break;
      case 0x20000001: property.description = "Score"; break;
      case 0x20008107: property.description = "Gamer PUID"; break;
      case 0x20008108: property.description = "Affiliate Value"; break;
      case 0x30008105: property.description = "Gamer Mu"; break;
      case 0x30008106: property.description = "Gamer Sigma"; break;
      case 0x40008002: property.description = "Gamer Name"; break;
      case 0x40008109: property.description = "Gamer Host Name"; break;
      case 0x50008104: property.description = "Gamer Rating"; break;
      default:
        property.description = fmt::format("Unknown Property {:08X}", property.id);
        break;
    }
  }
  return property;
