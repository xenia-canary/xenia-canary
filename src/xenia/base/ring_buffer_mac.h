...
#ifndef XENIA_BASE_RING_BUFFER_MAC_H_
#define XENIA_BASE_RING_BUFFER_MAC_H_
...
class RingBuffer {
 public:
  ...
  // Safe debug methods - no logging to avoid hangs
  const char* get_debug_state() const;
  bool is_valid() const;
...
#endif  // XENIA_BASE_RING_BUFFER_MAC_H_
