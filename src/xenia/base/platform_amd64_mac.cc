...
inline void SecureZeroBuffer(void* buffer, size_t size) {
...
#undef TEST_EMIT_FEATURE
  ...
  */
    ...
    SecureZeroBuffer(data, sizeof(data));
  }
  {
    unsigned int data[4] = {};
  ...
  if (is_rosetta) {
    if (!avx_ok) {
      feature_flags_ &=
          ~(kX64EmitAVX2 | kX64EmitFMA | kX64EmitAVX512F | kX64EmitAVX512VL |
            kX64EmitAVX512BW | kX64EmitAVX512DQ | kX64EmitAVX512VBMI |
            kX64EmitXOP | kX64EmitFMA4);
      XELOGW("Rosetta 2: AVX probe failed - masking AVX/FMA/XOP/AVX-512 flags");
    } else if (!avx2_ok) {
      feature_flags_ &=
          ~(kX64EmitAVX2 | kX64EmitAVX512F | kX64EmitAVX512VL |
            kX64EmitAVX512BW | kX64EmitAVX512DQ | kX64EmitAVX512VBMI);
      XELOGW("Rosetta 2: AVX2 probe failed - masking AVX2/AVX-512 flags");
    } else {
      XELOGI("Rosetta 2: AVX/AVX2 probes passed - keeping AVX feature flags");
    }
  }
#endif
