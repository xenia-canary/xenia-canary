...
%_ptr_Output_v4float = OpTypePointer Output %v4float
      ...
      %22880 = OpLoad %int %gl_VertexIndex
      %11437 = OpBitcast %uint %22880
       %9285 = OpLoad %int %gl_VertexIndex
      %18319 = OpBitcast %uint %9285
      %13147 = OpCompositeConstruct %v2uint %11437 %18319
      %18160 = OpShiftRightLogical %v2uint %13147 %1819
      %12212 = OpCompositeConstruct %v2uint %uint_1 %uint_1
      %18511 = OpBitwiseAnd %v2uint %18160 %12212
      %12470 = OpConvertUToF %v2float %18511
      %12606 = OpAccessChain %_ptr_PushConstant_v2float %4495 %int_1
      %24011 = OpLoad %v2float %12606
      %17243 = OpFMul %v2float %12470 %24011
...
const uint32_t guest_output_triangle_strip_rect_vs[] = {
    ...
    0x00040020, 0x0000029A, 0x00000003, 0x0000001D, 0x00050036, 0x00000008,
    0x0000161F, 0x00000000, 0x00000502, 0x000200F8, 0x00005D6B, 0x00050041,
    0x00000290, 0x00001B8D, 0x0000118F, 0x00000A0B, 0x0004003D, 0x00000013,
    0x0000446C, 0x00001B8D, 0x0004003D, 0x0000000C, 0x00005960, 0x00001029,
    0x0004007C, 0x0000000B, 0x00002CAD, 0x00005960, 0x0004003D, 0x0000000C,
    0x00002445, 0x00001029, 0x0004007C, 0x0000000B, 0x0000478F, 0x00002445,
    0x00050050, 0x00000011, 0x0000335B, 0x00002CAD, 0x0000478F, 0x000500C2,
    0x00000011, 0x000046F0, 0x0000335B, 0x0000071B, 0x00050050, 0x00000011,
    0x00002FB4, 0x00000A0D, 0x00000A0D, 0x000500C7, 0x00000011, 0x0000484F,
    0x000046F0, 0x00002FB4, 0x00040070, 0x00000013, 0x000030B6, 0x0000484F,
    0x00050041, 0x00000290, 0x0000313E, 0x0000118F, 0x00000A0E, 0x0004003D,
    0x00000013, 0x00005DCB, 0x0000313E, 0x00050085, 0x00000013, 0x0000435B,
    0x000030B6, 0x00005DCB, 0x00050081, 0x00000013, 0x000040D2, 0x0000446C,
    ...
    0x00050041, 0x0000029A, 0x00002F17, 0x00001342, 0x00000A0B, 0x0003003E,
