...
%_ptr_Output_v4float = OpTypePointer Output %v4float
      ...
      %24953 = OpLabel
       %5179 = OpVariable %_ptr_Function_v4float Function
      ...
      %16965 = OpLoad %508 %4927
       %7976 = OpSampledImage %510 %14905 %16965
      %23452 = OpConvertUToF %v2float %10630
      %12344 = OpCompositeConstruct %v2float %float_0_5 %float_0_5
      %19926 = OpFAdd %v2float %23452 %12344
      %24497 = OpAccessChain %_ptr_PushConstant_v2float %4495 %int_1
      %20800 = OpLoad %v2float %24497
      %24298 = OpFMul %v2float %19926 %20800
       %9271 = OpImageSampleExplicitLod %v4float %7976 %24298 Lod %float_0
      %21810 = OpVectorShuffle %v3float %9271 %9271 0 1 2
       %7805 = OpAccessChain %_ptr_Function_float %5179 %uint_0
      %13314 = OpCompositeExtract %float %21810 0
               OpStore %7805 %13314
      %16378 = OpAccessChain %_ptr_Function_float %5179 %uint_1
      %15746 = OpCompositeExtract %float %21810 1
               OpStore %16378 %15746
      %16379 = OpAccessChain %_ptr_Function_float %5179 %uint_2
      %15747 = OpCompositeExtract %float %21810 2
               OpStore %16379 %15747
      %19646 = OpAccessChain %_ptr_Function_float %5179 %uint_3
               OpStore %19646 %float_1
      %17934 = OpLoad %v4float %5179
               OpStore %5312 %17934
               OpReturn
               OpFunctionEnd
#endif
...
const uint32_t guest_output_bilinear_ps[] = {
    ...
    0x0000028F, 0x00000009, 0x00000012, 0x00040020, 0x0000029B, 0x00000007,
    0x0000001D, 0x00090019, 0x00000096, 0x0000000D, 0x00000001, 0x00000000,
    0x00000000, 0x00000000, 0x00000001, 0x00000000, 0x00040020, 0x00000313,
    0x00000000, 0x00000096, 0x0004003B, 0x00000313, 0x00001160, 0x00000000,
    0x0002001A, 0x000001FC, 0x00040020, 0x00000479, 0x00000000, 0x000001FC,
    0x0004003B, 0x00000479, 0x0000133F, 0x00000000, 0x0003001B, 0x000001FE,
    0x00000096, 0x0004002B, 0x0000000D, 0x000000FC, 0x3F000000, 0x0004002B,
    0x0000000C, 0x00000A0E, 0x00000001, 0x00040020, 0x00000290, 0x00000009,
    0x00000013, 0x0004002B, 0x0000000D, 0x00000A0C, 0x00000000, 0x00040017,
    0x00000018, 0x0000000D, 0x00000003, 0x0004002B, 0x0000000B, 0x00000A0A,
    0x00000000, 0x00040020, 0x0000028A, 0x00000007, 0x0000000D, 0x0004002B,
    ...
    0x0000000B, 0x00000A13, 0x00000003, 0x00040020, 0x0000029C, 0x00000003,
    0x0000001D, 0x0004003B, 0x0000029C, 0x000014C0, 0x00000003, 0x00050036,
    0x00000008, 0x0000161F, 0x00000000, 0x00000502, 0x000200F8, 0x00006179,
    0x0004003B, 0x0000029B, 0x0000143B, 0x00000007, 0x0004003D, 0x0000001D,
    ...
    0x000001FC, 0x00004245, 0x0000133F, 0x00050056, 0x000001FE, 0x00001F28,
    0x00003A39, 0x00004245, 0x00040070, 0x00000013, 0x00005B9C, 0x00002986,
    0x00050050, 0x00000013, 0x00003038, 0x000000FC, 0x000000FC, 0x00050081,
    0x00000013, 0x00004DD6, 0x00005B9C, 0x00003038, 0x00050041, 0x00000290,
    0x00005FB1, 0x0000118F, 0x00000A0E, 0x0004003D, 0x00000013, 0x00005140,
    0x00005FB1, 0x00050085, 0x00000013, 0x00005EEA, 0x00004DD6, 0x00005140,
    0x00070058, 0x0000001D, 0x00002437, 0x00001F28, 0x00005EEA, 0x00000002,
    0x00000A0C, 0x0008004F, 0x00000018, 0x00005532, 0x00002437, 0x00002437,
    0x00000000, 0x00000001, 0x00000002, 0x00050041, 0x0000028A, 0x00001E7D,
    0x0000143B, 0x00000A0A, 0x00050051, 0x0000000D, 0x00003402, 0x00005532,
    0x00000000, 0x0003003E, 0x00001E7D, 0x00003402, 0x00050041, 0x0000028A,
    0x00003FFA, 0x0000143B, 0x00000A0D, 0x00050051, 0x0000000D, 0x00003D82,
    0x00005532, 0x00000001, 0x0003003E, 0x00003FFA, 0x00003D82, 0x00050041,
    0x0000028A, 0x00003FFB, 0x0000143B, 0x00000A10, 0x00050051, 0x0000000D,
    0x00003D83, 0x00005532, 0x00000002, 0x0003003E, 0x00003FFB, 0x00003D83,
    0x00050041, 0x0000028A, 0x00004CBE, 0x0000143B, 0x00000A13, 0x0003003E,
    0x00004CBE, 0x0000008A, 0x0004003D, 0x0000001D, 0x0000460E, 0x0000143B,
    0x0003003E, 0x000014C0, 0x0000460E, 0x000100FD, 0x00010038,
};
