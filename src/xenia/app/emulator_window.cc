...
#define ADD_REGION(name, abbrev, id) \
      ...
      ADD_REGION("Region Free", "rf", xcConsoleRegion::RegionFree);
      ADD_REGION("USA (NTSC-U)", "us", xcConsoleRegion::US);
      ADD_REGION("Japan (NTSC-J)", "jp", xcConsoleRegion::Japan);
      ADD_REGION("Asia (NTSC-HK)", "asia", xcConsoleRegion::Asia);
      ADD_REGION("Europe (PAL)", "eu", xcConsoleRegion::Europe);
#undef ADD_REGION
    }
