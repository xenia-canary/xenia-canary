...
#ifndef XENIA_GPU_VULKAN_VULKAN_COMMAND_PROCESSOR_MAC_H_
#define XENIA_GPU_VULKAN_VULKAN_COMMAND_PROCESSOR_MAC_H_
...
#undef OVERRIDING_BASE_CMDPROCESSOR
 public:
  ...
  void DebugIssueSwapFromHost(uint32_t width, uint32_t height) override;
 ...
 private:
  ...
  // Debug-only synthetic swap injection state (used when the guest never swaps).
  uint32_t debug_swap_frontbuffer_virtual_ = 0;
  uint32_t debug_swap_frontbuffer_physical_ = 0;
  uint32_t debug_swap_frontbuffer_size_ = 0;
  uint32_t debug_swap_frontbuffer_width_ = 0;
  uint32_t debug_swap_frontbuffer_height_ = 0;
  uint32_t debug_swap_frontbuffer_pitch_pixels_ = 0;
  uint64_t debug_swap_frame_ = 0;
...
#endif  // XENIA_GPU_VULKAN_VULKAN_COMMAND_PROCESSOR_MAC_H_
