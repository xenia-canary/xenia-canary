...
VulkanTextureCache::VulkanTexture::~VulkanTexture() {
  ...
  // Skip view cleanup for now on macOS
#ifndef __APPLE__
  const ui::vulkan::VulkanDevice* const vulkan_device =
...
bool VulkanTextureCache::Initialize() {
  ...
  VkFormatProperties a2b10g10r10_snorm_properties;
  ifn.vkGetPhysicalDeviceFormatProperties(physical_device,
                                          VK_FORMAT_A2B10G10R10_SNORM_PACK32,
                                          &a2b10g10r10_snorm_properties);
  ...
  if ((a2b10g10r10_snorm_properties.optimalTilingFeatures &
       VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT) == 0) {
    auto apply_a2b10_snorm_fallback = [&](xenos::TextureFormat format) {
    ...
    apply_a2b10_snorm_fallback(xenos::TextureFormat::k_2_10_10_10);
    apply_a2b10_snorm_fallback(
        xenos::TextureFormat::k_2_10_10_10_AS_16_16_16_16);
    XELOGGPU(
        "VulkanTextureCache: A2B10G10R10_SNORM not supported - "
        "falling back to unsigned format for signed 2_10_10_10 textures");
  }
