...
DEFINE_int32(
    ...
    "GPU");
DEFINE_bool(trace_gpu_bootstrap, false,
            "Trace guest GPU bootstrap (Vd import binding/calls and CP ring "
            "MMIO write path) for no-swap/no-video startup diagnosis.",
            "GPU");
