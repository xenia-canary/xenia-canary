...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
      ...
      %14215 = OpLoad %v4uint %5262
               OpStore %14457 %14215
      %24953 = OpFunctionCall %void %5168 %14457 %14458 %14459
      ...
      %14216 = OpLoad %v4uint %5262
               OpStore %14465 %14216
      %24954 = OpFunctionCall %void %5168 %14465 %14409 %5786
      ...
      %13321 = OpAccessChain %_ptr_Uniform_v4uint %5134 %int_0 %12207
               ...
               OpReturn
               OpFunctionEnd
       %3563 = OpFunction %v4uint None %239
      %22885 = OpFunctionParameter %_ptr_Function_v2uint
      %14287 = OpLabel
      %23860 = OpLoad %v2uint %22885
      %15348 = OpCompositeConstruct %v2uint %uint_24 %uint_24
       %8960 = OpShiftRightLogical %v2uint %23860 %15348
      %23550 = OpLoad %v2uint %22885
      %22649 = OpCompositeConstruct %v2uint %uint_65280 %uint_65280
      %24125 = OpBitwiseAnd %v2uint %23550 %22649
      %22105 = OpCompositeConstruct %v2uint %uint_8 %uint_8
      ...
      %14013 = OpBitwiseOr %v2uint %8960 %18899
       %6928 = OpLoad %v2uint %22885
      %21840 = OpCompositeConstruct %v2uint %uint_255 %uint_255
      %24126 = OpBitwiseAnd %v2uint %6928 %21840
      %21744 = OpCompositeConstruct %v2uint %uint_8 %uint_8
      %13473 = OpShiftLeftLogical %v2uint %24126 %21744
      %16595 = OpLoad %v2uint %22885
      %24262 = OpCompositeConstruct %v2uint %uint_16711680 %uint_16711680
      %24087 = OpBitwiseAnd %v2uint %16595 %24262
      %22470 = OpCompositeConstruct %v2uint %uint_8 %uint_8
       %7347 = OpShiftRightLogical %v2uint %24087 %22470
       %9843 = OpCompositeExtract %uint %13473 0
      %23152 = OpCompositeExtract %uint %13473 1
      ...
      %16149 = OpVectorShuffle %v2uint %15164 %15164 0 1
               OpStore %18646 %16149
       %8728 = OpFunctionCall %v4uint %3563 %18646
               OpStore %5857 %8728
       %6347 = OpLoad %v4uint %3982
      %15340 = OpVectorShuffle %v2uint %6347 %6347 2 3
               OpStore %23362 %15340
      %12376 = OpFunctionCall %v4uint %3563 %23362
               OpStore %4866 %12376
               OpReturn
               OpFunctionEnd
...
const uint32_t texture_load_gbgr8_rgb8_cs[] = {
    ...
    0x00000288, 0x0004002B, 0x0000000B, 0x00000A52, 0x00000018, 0x0004002B,
    0x0000000B, 0x00000A87, 0x0000FF00, 0x0004002B, 0x0000000B, 0x00000A22,
    0x00000008, 0x0004002B, 0x0000000B, 0x0000014A, 0x00000101, 0x0004002B,
