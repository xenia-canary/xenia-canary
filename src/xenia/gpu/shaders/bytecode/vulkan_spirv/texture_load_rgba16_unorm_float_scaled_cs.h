...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
      ...
      %24590 = OpLabel
      %21486 = OpLoad %uint %5442
      %17951 = OpIEqual %bool %21486 %uint_1
      %24014 = OpLoad %uint %5442
       %9069 = OpIEqual %bool %24014 %uint_2
      %22833 = OpLogicalOr %bool %17951 %9069
               OpSelectionMerge %25257 None
               OpBranchConditional %22833 %14904 %25257
      %14904 = OpLabel
      ...
      %21712 = OpShiftRightLogical %v4uint %8125 %8712
       %9679 = OpBitwiseOr %v4uint %10125 %21712
               ...
               OpBranch %25257
      %25257 = OpLabel
      %10665 = OpLoad %uint %5442
      %17952 = OpIEqual %bool %10665 %uint_2
      %24015 = OpLoad %uint %5442
       %9070 = OpIEqual %bool %24015 %uint_3
      %22834 = OpLogicalOr %bool %17952 %9070
               OpSelectionMerge %7782 None
               OpBranchConditional %22834 %14905 %7782
      %14905 = OpLabel
      %13764 = OpLoad %v4uint %5807
      %11654 = OpCompositeConstruct %v4uint %uint_16 %uint_16 %uint_16 %uint_16
      %14754 = OpShiftLeftLogical %v4uint %13764 %11654
      %19609 = OpLoad %v4uint %5807
      %24002 = OpCompositeConstruct %v4uint %uint_16 %uint_16 %uint_16 %uint_16
       %7270 = OpShiftRightLogical %v4uint %19609 %24002
       %9680 = OpBitwiseOr %v4uint %14754 %7270
               OpStore %5807 %9680
               OpBranch %7782
       %7782 = OpLabel
...
const uint32_t texture_load_rgba16_unorm_float_scaled_cs[] = {
    ...
    0x00003872, 0x00000A22, 0x00080039, 0x0000000C, 0x000046E2, 0x00000DA0,
    ...
    0x00003874, 0x00002B47, 0x0003003E, 0x00003875, 0x00000A22, 0x0003003E,
    0x00003876, 0x00000A13, 0x00080039, 0x0000000B, 0x000061DA, 0x00000F52,
    ...
    0x00000A13, 0x00070039, 0x0000000B, 0x000061C7, 0x000013A3, 0x0000387A,
    ...
    0x0000600E, 0x0004003D, 0x0000000B, 0x000053EE, 0x00001542, 0x000500AA,
    0x00000009, 0x0000461F, 0x000053EE, 0x00000A0D, 0x0004003D, 0x0000000B,
    0x00005DCE, 0x00001542, 0x000500AA, 0x00000009, 0x0000236D, 0x00005DCE,
    0x00000A10, 0x000500A6, 0x00000009, 0x00005931, 0x0000461F, 0x0000236D,
    0x000300F7, 0x000062A9, 0x00000000, 0x000400FA, 0x00005931, 0x00003A38,
    0x000062A9, 0x000200F8, 0x00003A38, 0x0004003D, 0x00000017, 0x000035FD,
    ...
    0x000025CF, 0x000200F9, 0x000062A9, 0x000200F8, 0x000062A9, 0x0004003D,
    0x0000000B, 0x000029A9, 0x00001542, 0x000500AA, 0x00000009, 0x00004620,
    0x000029A9, 0x00000A10, 0x0004003D, 0x0000000B, 0x00005DCF, 0x00001542,
    0x000500AA, 0x00000009, 0x0000236E, 0x00005DCF, 0x00000A13, 0x000500A6,
    0x00000009, 0x00005932, 0x00004620, 0x0000236E, 0x000300F7, 0x00001E66,
    0x00000000, 0x000400FA, 0x00005932, 0x00003A39, 0x00001E66, 0x000200F8,
    0x00003A39, 0x0004003D, 0x00000017, 0x000035C4, 0x000016AF, 0x00070050,
    0x00000017, 0x00002D86, 0x00000A3A, 0x00000A3A, 0x00000A3A, 0x00000A3A,
    0x000500C4, 0x00000017, 0x000039A2, 0x000035C4, 0x00002D86, 0x0004003D,
    0x00000017, 0x00004C99, 0x000016AF, 0x00070050, 0x00000017, 0x00005DC2,
    0x00000A3A, 0x00000A3A, 0x00000A3A, 0x00000A3A, 0x000500C2, 0x00000017,
    0x00001C66, 0x00004C99, 0x00005DC2, 0x000500C5, 0x00000017, 0x000025D0,
    0x000039A2, 0x00001C66, 0x0003003E, 0x000016AF, 0x000025D0, 0x000200F9,
