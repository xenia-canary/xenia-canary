...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
      ...
      %15268 = OpLoad %v4uint %5262
               OpStore %14457 %15268
      %24261 = OpFunctionCall %v4uint %5846 %14457
      ...
      %15269 = OpLoad %v4uint %5262
               OpStore %5786 %15269
      %24262 = OpFunctionCall %v4uint %5846 %5786
      ...
      %10674 = OpCompositeConstruct %v2uint %22752 %22752
               OpReturnValue %10674
               OpFunctionEnd
       %5846 = OpFunction %v4uint None %257
       %3982 = OpFunctionParameter %_ptr_Function_v4uint
      %18500 = OpLabel
      %22281 = OpLoad %v4uint %3982
      %13170 = OpCompositeConstruct %v4uint %uint_268374015 %uint_268374015 %uint_268374015 %uint_268374015
      %22451 = OpBitwiseAnd %v4uint %22281 %13170
       %7456 = OpCompositeConstruct %v4uint %uint_4 %uint_4 %uint_4 %uint_4
      %11799 = OpShiftLeftLogical %v4uint %22451 %7456
      %21378 = OpLoad %v4uint %3982
      %22588 = OpCompositeConstruct %v4uint %uint_4026593280 %uint_4026593280 %uint_4026593280 %uint_4026593280
      %22413 = OpBitwiseAnd %v4uint %21378 %22588
      %10386 = OpCompositeConstruct %v4uint %uint_12 %uint_12 %uint_12 %uint_12
...
const uint32_t texture_load_r4g4b4a4_a4r4g4b4_scaled_cs[] = {
    ...
    0x00050039, 0x00000017, 0x00005EC5, 0x000016D6, 0x00003879, 0x00060041,
    ...
    0x00003BA5, 0x00050039, 0x00000017, 0x00005EC6, 0x000016D6, 0x0000169A,
    ...
    0x000200FE, 0x000029B2, 0x00010038, 0x00050036, 0x00000017, 0x000016D6,
    ...
    0x00000017, 0x00003372, 0x00000501, 0x00000501, 0x00000501, 0x00000501,
    0x000500C7, 0x00000017, 0x000057B3, 0x00005709, 0x00003372, 0x00070050,
    0x00000017, 0x00001D20, 0x00000A16, 0x00000A16, 0x00000A16, 0x00000A16,
    ...
    0x000009A2, 0x000009A2, 0x000009A2, 0x000009A2, 0x000500C7, 0x00000017,
