...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
      ...
      %16327 = OpVectorShuffle %v2uint %12422 %12422 0 2
               OpStore %14459 %16327
       %6793 = OpFunctionCall %v4uint %3507 %14459
      ...
      %15732 = OpLoad %v4uint %5891
       %9321 = OpVectorShuffle %v2uint %15732 %15732 0 2
               OpStore %14460 %9321
       %6794 = OpFunctionCall %v4uint %3507 %14460
      ...
      %16328 = OpVectorShuffle %v2uint %12423 %12423 0 1
               OpStore %14461 %16328
       %6795 = OpFunctionCall %v4uint %3507 %14461
      ...
      %15733 = OpLoad %v4uint %4776
       %9322 = OpVectorShuffle %v2uint %15733 %15733 2 3
               OpStore %14462 %9322
       %6796 = OpFunctionCall %v4uint %3507 %14462
      ...
      %16329 = OpVectorShuffle %v2uint %12424 %12424 1 3
               OpStore %14463 %16329
       %6797 = OpFunctionCall %v4uint %3507 %14463
      ...
      %15734 = OpLoad %v4uint %5891
       %9323 = OpVectorShuffle %v2uint %15734 %15734 1 3
               OpStore %14464 %9323
       %6798 = OpFunctionCall %v4uint %3507 %14464
      ...
      %16330 = OpVectorShuffle %v2uint %12425 %12425 0 1
               OpStore %14409 %16330
       %6799 = OpFunctionCall %v4uint %3507 %14409
      ...
      %15735 = OpLoad %v4uint %4776
       %9324 = OpVectorShuffle %v2uint %15735 %15735 2 3
               OpStore %5786 %9324
       %6800 = OpFunctionCall %v4uint %3507 %5786
      ...
      %14903 = OpLabel
               OpReturn
               OpFunctionEnd
       %3507 = OpFunction %v4uint None %239
      ...
      %21744 = OpCompositeConstruct %v4uint %uint_4 %uint_4 %uint_4 %uint_4
      ...
      %24328 = OpCompositeConstruct %v4uint %uint_20 %uint_20 %uint_20 %uint_20
      ...
      %24329 = OpCompositeConstruct %v4uint %uint_8 %uint_8 %uint_8 %uint_8
      ...
      %24330 = OpCompositeConstruct %v4uint %uint_24 %uint_24 %uint_24 %uint_24
      ...
      %25153 = OpBitwiseAnd %v4uint %8187 %12643
      %24331 = OpCompositeConstruct %v4uint %uint_12 %uint_12 %uint_12 %uint_12
       %8658 = OpShiftLeftLogical %v4uint %25153 %24331
      %22089 = OpBitwiseOr %v4uint %22088 %8658
      %13426 = OpLoad %v2uint %5464
      %11830 = OpVectorShuffle %v4uint %13426 %13426 0 0 1 1
       %8188 = OpShiftRightLogical %v4uint %11830 %395
      %12644 = OpCompositeConstruct %v4uint %uint_1 %uint_1 %uint_1 %uint_1
      %25154 = OpBitwiseAnd %v4uint %8188 %12644
      %24332 = OpCompositeConstruct %v4uint %uint_28 %uint_28 %uint_28 %uint_28
       %8659 = OpShiftLeftLogical %v4uint %25154 %24332
      %22090 = OpBitwiseOr %v4uint %22089 %8659
      %13427 = OpLoad %v2uint %5464
      %11831 = OpVectorShuffle %v4uint %13427 %13427 0 0 1 1
       %8189 = OpShiftRightLogical %v4uint %11831 %125
      %14862 = OpCompositeConstruct %v4uint %uint_1 %uint_1 %uint_1 %uint_1
      %21414 = OpBitwiseAnd %v4uint %8189 %14862
      %14882 = OpBitwiseOr %v4uint %22090 %21414
      %12614 = OpLoad %v2uint %5464
      %11832 = OpVectorShuffle %v4uint %12614 %12614 0 0 1 1
      ...
      %24333 = OpCompositeConstruct %v4uint %uint_16 %uint_16 %uint_16 %uint_16
       %8674 = OpShiftLeftLogical %v4uint %25155 %24333
      %21571 = OpBitwiseOr %v4uint %14882 %8674
               OpStore %5055 %21571
...
const uint32_t texture_load_dxt3aas1111_argb4_cs[] = {
    ...
    0x00000A16, 0x00000004, 0x0004002B, 0x0000000B, 0x00000A1F, 0x00000007,
    ...
    0x0000000B, 0x00000A46, 0x00000014, 0x0004002B, 0x0000000B, 0x00000A10,
    ...
    0x00000A34, 0x0004002B, 0x0000000B, 0x00000A52, 0x00000018, 0x0004002B,
    ...
    0x00000A2E, 0x0000000C, 0x0004002B, 0x0000000B, 0x00000A19, 0x00000005,
    0x0004002B, 0x0000000B, 0x00000A31, 0x0000000D, 0x0007002C, 0x00000017,
    0x0000018B, 0x00000A19, 0x00000A31, 0x00000A19, 0x00000A31, 0x0004002B,
    0x0000000B, 0x00000A5E, 0x0000001C, 0x0004002B, 0x0000000B, 0x00000A0A,
    0x00000000, 0x0007002C, 0x00000017, 0x0000007D, 0x00000A0A, 0x00000A22,
    0x00000A0A, 0x00000A22, 0x0007002C, 0x00000017, 0x00000155, 0x00000A16,
    0x00000A2E, 0x00000A16, 0x00000A2E, 0x0004002B, 0x0000000B, 0x00000A3A,
    0x00000010, 0x0004002B, 0x0000000B, 0x000008A6, 0x00FF00FF, 0x0004002B,
    ...
    0x00050039, 0x00000017, 0x00001A89, 0x00000DB3, 0x0000387B, 0x00060041,
    ...
    0x00002469, 0x00050039, 0x00000017, 0x00001A8A, 0x00000DB3, 0x0000387C,
    ...
    0x00000DB3, 0x0000387D, 0x00060041, 0x00000296, 0x00002389, 0x0000140E,
    ...
    0x00001A8C, 0x00000DB3, 0x0000387E, 0x00060041, 0x00000296, 0x000023D5,
    ...
    0x0000387F, 0x00003FC9, 0x00050039, 0x00000017, 0x00001A8D, 0x00000DB3,
    ...
    0x00000DB3, 0x00003880, 0x00060041, 0x00000296, 0x000023D6, 0x0000140E,
    ...
    0x00000017, 0x00001A8F, 0x00000DB3, 0x00003849, 0x00060041, 0x00000296,
    ...
    0x00050039, 0x00000017, 0x00001A90, 0x00000DB3, 0x0000169A, 0x00060041,
    ...
    0x00000DB3, 0x00000000, 0x000000EF, 0x00030037, 0x0000028E, 0x00001558,
    ...
    0x00070050, 0x00000017, 0x000054F0, 0x00000A16, 0x00000A16, 0x00000A16,
