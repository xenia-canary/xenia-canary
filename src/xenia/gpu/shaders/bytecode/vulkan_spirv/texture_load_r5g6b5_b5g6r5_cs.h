...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_4 %uint_32 %uint_1
      ...
      %15268 = OpLoad %v4uint %5262
               OpStore %14457 %15268
      %24261 = OpFunctionCall %v4uint %3693 %14457
      ...
      %15269 = OpLoad %v4uint %5262
               OpStore %5786 %15269
      %24262 = OpFunctionCall %v4uint %3693 %5786
      %12744 = OpAccessChain %_ptr_Uniform_v4uint %5134 %int_0 %14484
               OpStore %12744 %24262
               OpReturn
               OpFunctionEnd
       %3693 = OpFunction %v4uint None %257
       %3982 = OpFunctionParameter %_ptr_Function_v4uint
      %12273 = OpLabel
      %21707 = OpLoad %v4uint %3982
      %12235 = OpCompositeConstruct %v4uint %uint_132122592 %uint_132122592 %uint_132122592 %uint_132122592
      ...
      %21877 = OpBitwiseAnd %v4uint %13600 %21205
       %9466 = OpCompositeConstruct %v4uint %uint_11 %uint_11 %uint_11 %uint_11
       %6407 = OpShiftLeftLogical %v4uint %21877 %9466
      %19857 = OpBitwiseOr %v4uint %22960 %6407
      %17554 = OpLoad %v4uint %3982
       %6978 = OpCompositeConstruct %v4uint %uint_4160813056 %uint_4160813056 %uint_4160813056 %uint_4160813056
      %21839 = OpBitwiseAnd %v4uint %17554 %6978
       %9812 = OpCompositeConstruct %v4uint %uint_11 %uint_11 %uint_11 %uint_11
...
const uint32_t texture_load_r5g6b5_b5g6r5_cs[] = {
    ...
    0x00000798, 0x00000288, 0x00000288, 0x0004002B, 0x0000000B, 0x00000902,
    0x07E007E0, 0x0004002B, 0x0000000B, 0x000000EC, 0x001F001F, 0x0004002B,
    0x0000000B, 0x00000A2B, 0x0000000B, 0x0004002B, 0x0000000B, 0x000002FC,
    0xF800F800, 0x0004002B, 0x0000000B, 0x00000A0D, 0x00000001, 0x0004002B,
    ...
    0x00050039, 0x00000017, 0x00005EC5, 0x00000E6D, 0x00003879, 0x00060041,
    ...
    0x00003BA5, 0x00050039, 0x00000017, 0x00005EC6, 0x00000E6D, 0x0000169A,
    ...
    0x00000017, 0x00000E6D, 0x00000000, 0x00000101, 0x00030037, 0x00000294,
    0x00000F8E, 0x000200F8, 0x00002FF1, 0x0004003D, 0x00000017, 0x000054CB,
    0x00000F8E, 0x00070050, 0x00000017, 0x00002FCB, 0x00000902, 0x00000902,
    0x00000902, 0x00000902, 0x000500C7, 0x00000017, 0x000059B0, 0x000054CB,
    ...
    0x00000017, 0x000024FA, 0x00000A2B, 0x00000A2B, 0x00000A2B, 0x00000A2B,
    ...
    0x00004492, 0x00000F8E, 0x00070050, 0x00000017, 0x00001B42, 0x000002FC,
    0x000002FC, 0x000002FC, 0x000002FC, 0x000500C7, 0x00000017, 0x0000554F,
    0x00004492, 0x00001B42, 0x00070050, 0x00000017, 0x00002654, 0x00000A2B,
    0x00000A2B, 0x00000A2B, 0x00000A2B, 0x000500C2, 0x00000017, 0x00001CDD,
