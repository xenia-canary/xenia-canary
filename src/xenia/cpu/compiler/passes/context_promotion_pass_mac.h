...
#ifndef XENIA_CPU_COMPILER_PASSES_CONTEXT_PROMOTION_PASS_MAC_H_
#define XENIA_CPU_COMPILER_PASSES_CONTEXT_PROMOTION_PASS_MAC_H_
...
#endif  // XENIA_CPU_COMPILER_PASSES_CONTEXT_PROMOTION_PASS_MAC_H_
