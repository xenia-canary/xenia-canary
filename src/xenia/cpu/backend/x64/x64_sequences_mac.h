...
#ifndef XENIA_CPU_BACKEND_X64_X64_SEQUENCES_MAC_H_
#define XENIA_CPU_BACKEND_X64_X64_SEQUENCES_MAC_H_
...
#ifdef __APPLE__
// On macOS, use a Meyer's singleton to avoid static initialization order issues
std::unordered_map<uint32_t, SequenceSelectFn>& GetSequenceTable();
#else
...
#endif  // XENIA_CPU_BACKEND_X64_X64_SEQUENCES_MAC_H_
