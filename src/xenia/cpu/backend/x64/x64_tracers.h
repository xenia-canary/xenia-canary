...
void TraceContextLoadF32(void* raw_context, uint64_t offset, const void* value);
void TraceContextLoadF64(void* raw_context, uint64_t offset, const void* value);
...
void TraceMemoryLoadF32(void* raw_context, uint32_t address, const void* value);
void TraceMemoryLoadF64(void* raw_context, uint32_t address, const void* value);
