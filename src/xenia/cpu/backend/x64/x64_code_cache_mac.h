...
#ifndef XENIA_CPU_BACKEND_X64_X64_CODE_CACHE_MAC_H_
#define XENIA_CPU_BACKEND_X64_X64_CODE_CACHE_MAC_H_
...
class X64CodeCache : public CodeCache {
 public:
  ...
  void SetCachePressureHandler(void* handler);
...
#endif  // XENIA_CPU_BACKEND_X64_X64_CODE_CACHE_MAC_H_
