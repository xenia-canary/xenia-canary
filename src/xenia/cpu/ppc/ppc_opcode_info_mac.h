...
#ifndef XENIA_CPU_PPC_PPC_OPCODE_INFO_MAC_H_
#define XENIA_CPU_PPC_PPC_OPCODE_INFO_MAC_H_
...
// Debug helpers for tracking the most recent PPC decode address.
...
#endif  // XENIA_CPU_PPC_PPC_OPCODE_INFO_MAC_H_
