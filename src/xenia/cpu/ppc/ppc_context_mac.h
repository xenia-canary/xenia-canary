...
#ifndef XENIA_CPU_PPC_PPC_CONTEXT_MAC_H_
#define XENIA_CPU_PPC_PPC_CONTEXT_MAC_H_
...
typedef struct alignas(64) PPCContext_s {
  ...
  // Debug: last guest PC written by JIT (see track_guest_pc).
  // Updated at each source offset when enabled.
  uint32_t current_pc;
  uint32_t current_pc_padding;
...
#endif  // XENIA_CPU_PPC_PPC_CONTEXT_MAC_H_
