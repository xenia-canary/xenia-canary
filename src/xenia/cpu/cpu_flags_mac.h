...
#ifndef XENIA_CPU_CPU_FLAGS_MAC_H_
#define XENIA_CPU_CPU_FLAGS_MAC_H_
...
// VMX2NEON support for Apple Silicon
DECLARE_bool(vmx2neon);
#include "xenia/base/cvar.h"
...
#endif  // XENIA_CPU_CPU_FLAGS_MAC_H_
