...
#ifndef XENIA_CPU_XEX_MODULE_MAC_H_
#define XENIA_CPU_XEX_MODULE_MAC_H_
 ...
 public:
  ...
  struct ImportLibrary {
   public:
    ...
    // Raw import table record counts from the XEX import library descriptor.
    // These may differ from logical imports because many titles have
    // type-0/type-1 (variable/thunk) record pairs per import.
    uint32_t import_record_count = 0;
    uint32_t variable_record_count = 0;
    uint32_t thunk_record_count = 0;
...
#endif  // XENIA_CPU_XEX_MODULE_MAC_H_
